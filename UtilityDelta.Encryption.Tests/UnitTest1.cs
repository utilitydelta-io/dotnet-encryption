...
namespace UtilityDelta.Encryption.Tests
{
    public class SimulateClientServerInteraction
    {
        ...
        public async Task TestAsync()
        {
            ...
            await m1SymmetricEncryption.EncryptAsync(m1UnencryptedTextFileStream, m2ReceivedEncryptedFile);
            ...
            await m2SymmetricEncryption.DecryptAsync(new MemoryStream(m2ReceivedEncryptedFileBytes), m2DecryptedFile);
